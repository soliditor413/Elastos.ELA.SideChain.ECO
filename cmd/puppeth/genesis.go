// Copyright 2017 The Elastos.ELA.SideChain.ECO Authors
...
import (
	...
	math2 "github.com/elastos/Elastos.ELA.SideChain.ECO/common/math"
...
// newAlethGenesisSpec converts a Elastos.ELA.SideChain.ECO genesis block into a Aleth-specific
// chain specification format.
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	// Only ethash is currently supported between Elastos.ELA.SideChain.ECO and aleth
...
// newParityChainSpec converts a Elastos.ELA.SideChain.ECO genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only ethash is currently supported between Elastos.ELA.SideChain.ECO and Parity
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
...
// newPyEthereumGenesisSpec converts a Elastos.ELA.SideChain.ECO genesis block into a Parity specific
// chain specification format.
func newPyEthereumGenesisSpec(network string, genesis *core.Genesis) (*pyEthereumGenesisSpec, error) {
	// Only ethash is currently supported between Elastos.ELA.SideChain.ECO and pyethereum
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
