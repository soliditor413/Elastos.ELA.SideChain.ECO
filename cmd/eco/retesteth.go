// Copyright 2019 The Elastos.ELA.SideChain.ECO Authors
...
import (
	...
	"github.com/elastos/Elastos.ELA.SideChain.ECO/consensus/misc"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/core"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/core/rawdb"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/core/state"
...
var (
	...
	retestethCommand = cli.Command{
		...
		Name:        "retesteth",
		Usage:       "Launches eco in retesteth mode",
		ArgsUsage:   "",
		Flags:       []cli.Flag{rpcPortFlag},
		Category:    "MISCELLANEOUS COMMANDS",
		Description: `Launches eco in retesteth mode (no database, no network, only retesteth RPC interface)`,
	}
)
