...
// This file is part of Elastos.ELA.SideChain.ECO.
//
// Elastos.ELA.SideChain.ECO is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// Elastos.ELA.SideChain.ECO is distributed in the hope that it will be useful,
...
// Package utils contains internal helper functions for Elastos.ELA.SideChain.ECO commands.
package utils
...
import (
	...
	"github.com/elastos/Elastos.ELA.SideChain.ECO/accounts"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/accounts/keystore"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/common"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/common/fdlimit"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/consensus"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/consensus/clique"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/consensus/ethash"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/consensus/pbft"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/core"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/core/vm"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/crypto"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/dashboard"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/eth"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/eth/downloader"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/eth/gasprice"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/ethdb"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/ethstats"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/graphql"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/les"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/log"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/metrics"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/metrics/influxdb"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/miner"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/node"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/p2p"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/p2p/discv5"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/p2p/enode"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/p2p/nat"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/p2p/netutil"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/params"
	"github.com/elastos/Elastos.ELA.SideChain.ECO/rpc"
	whisper "github.com/elastos/Elastos.ELA.SideChain.ECO/whisper/whisperv6"
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `eco account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *eth.Config) {
	...
	cfg.EvilSignersJournalDir = filepath.Join(node.DefaultDataDir(), "eco")
	if ctx.GlobalIsSet(DataDirFlag.Name) {
		cfg.EvilSignersJournalDir = filepath.Join(ctx.GlobalString(DataDirFlag.Name), "eco")
	}
	...
	case ctx.GlobalBool(RinkebyFlag.Name):
		...
		if !ctx.GlobalIsSet(DataDirFlag.Name) {
			cfg.EvilSignersJournalDir = filepath.Join(node.DefaultDataDir(), "rinkeby", "eco")
		}
	case ctx.GlobalBool(GoerliFlag.Name):
		if !ctx.GlobalIsSet(NetworkIdFlag.Name) {
			cfg.NetworkId = 12343
		...
		if !ctx.GlobalIsSet(DataDirFlag.Name) {
			cfg.EvilSignersJournalDir = filepath.Join(node.DefaultDataDir(), "goerli", "eco")
		}
	case ctx.GlobalBool(DeveloperFlag.Name):
		if !ctx.GlobalIsSet(NetworkIdFlag.Name) {
			cfg.NetworkId = 1337
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "eco.", tagsMap)
		}
	}
}
...
// new format.
//
// e.g. eco account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// eco --keystore /tmp/mykeystore --lightkdf account new
//
