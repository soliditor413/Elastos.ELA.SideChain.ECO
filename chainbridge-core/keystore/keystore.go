...
For more information on how to encrypt and decrypt from the command line, reference the README: https://github.com/elastos/Elastos.ELA.SideChain.ECO/ChainBridge
