...
[Installation Instructions](https://github.com/elastos/Elastos.ELA.SideChain.ECO/wiki/Building-Ethereum)
on the wiki.
...
The Elastos.ELA.SideChain.ECO project comes with several wrappers/executables found in the `cmd`
directory.

| Command    | Description |
|:----------:|-------------|
| **`geth`** | Our main ELA-Ethereum CLI client. It is the entry point into the ELA-Ethereum  network (main-, test- or private net), capable of running as a full node (default), archive node (retaining all historical state) or a light node (retrieving data live). It can be used by other processes as a gateway into the Ethereum network via JSON RPC endpoints exposed on top of HTTP, WebSocket and/or IPC transports. `geth --help` and the [CLI Wiki page](https://github.com/elastos/Elastos.ELA.SideChain.ECO/wiki/Command-Line-Options) for command line options. |
| `abigen` | Source code generator to convert Ethereum contract definitions into easy to use, compile-time type-safe Go packages. It operates on plain [Ethereum contract ABIs](https://github.com/ethereum/wiki/wiki/Ethereum-Contract-ABI) with expanded functionality if the contract bytecode is also available. However it also accepts Solidity source files, making development much more streamlined. Please see our [Native DApps](https://github.com/elastos/Elastos.ELA.SideChain.ECO/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts) wiki page for details. |
...
[CLI Wiki page](https://github.com/elastos/Elastos.ELA.SideChain.ECO/wiki/Command-Line-Options)),
 ...
 * Start up `geth`'s built-in interactive [JavaScript console](https://github.com/elastos/Elastos.ELA.SideChain.ECO/wiki/JavaScript-Console),
   ...
   as well as `geth`'s own [management APIs](https://github.com/elastos/Elastos.ELA.SideChain.ECO/wiki/Management-APIs).
...
supported by Elastos.ELA.SideChain.ECO.
...
```shell
$ eco --config /path/to/your_config.toml
```
...
```shell
$ eco --your-favourite-flags dumpconfig
```
...
[Geth specific APIs](https://github.com/elastos/Elastos.ELA.SideChain.ECO/wiki/Management-APIs)). These can be
...
```shell
$ eco --datadir=path/to/custom/data/folder --bootnodes=<bootnode-enode-url-from-above>
```
...
```shell
$ eco <usual-flags> --mine --miner.threads=1 --etherbase=0x0000000000000000000000000000000000000000
```
...
If you'd like to contribute to Elastos.ELA.SideChain.ECO, please fork, fix, commit and send a pull request
for the maintainers to review and merge into the main code base. If you wish to submit
more complex changes though, please check up with the core devs first on [our gitter channel](https://gitter.im/elastos/Elastos.ELA.SideChain.ECO)
...
Please see the [Developers' Guide](https://github.com/elastos/Elastos.ELA.SideChain.ECO/wiki/Developers'-Guide)
for more details on configuring your environment, managing project dependencies, and
testing procedures.

## License

The Elastos.ELA.SideChain.ECO library (i.e. all code outside of the `cmd` directory) is licensed under the
[GNU Lesser General Public License v3.0](https://www.gnu.org/licenses/lgpl-3.0.en.html),
also included in our repository in the `COPYING.LESSER` file.

The Elastos.ELA.SideChain.ECO binaries (i.e. all code inside of the `cmd` directory) is licensed under the
