...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/elastos/Elastos.ELA.SideChain.ECO/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of Elastos.ELA.SideChain.ECO authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The Elastos.ELA.SideChain.ECO Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "Elastos.ELA.SideChain.ECO"
	}
	if startOfSentence {
		return "The Elastos.ELA.SideChain.ECO library"
	}
	return "the Elastos.ELA.SideChain.ECO library"
}
