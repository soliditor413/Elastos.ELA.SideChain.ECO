...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "eco.ipc", false, filepath.Join(os.TempDir(), "eco.ipc")},
		{"data", "eco.ipc", false, "data/eco.ipc"},
		{"data", "./eco.ipc", false, "./eco.ipc"},
		{"data", "/eco.ipc", false, "/eco.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "eco.ipc", true, `\\.\pipe\geth.ipc`},
		{"data", "eco.ipc", true, `\\.\pipe\geth.ipc`},
