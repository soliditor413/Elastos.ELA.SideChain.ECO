...
//
// Detailed usage document and tutorial available on the Elastos.ELA.SideChain.ECO Wiki page:
// https://github.com/elastos/Elastos.ELA.SideChain.ECO/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
